  ...
  return (
    <li className="relative flex items-center">
      ...
      <div
        ...
        className={`absolute -right-27 top-full mt-4 flex h-60 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default sm:right-0 sm:w-80 ${
          dropdownOpen ? 'block' : 'hidden'
        }`}
      >
        <div className="px-4.5 py-3">
          <h5 id="Notifications" className="text-sm font-medium text-bodydark2">
            Notifications
          </h5>
        </div>

        <ul className="flex h-auto flex-col overflow-y-auto" role="none">
          <li role="none">
            <Link
              role="menuitem"
            ...
            >
              ...
              <p className="text-xs">1 Jan, 2025</p>
            </Link>
          </li>
          <li role="none">
            <Link
            ...
            >
              <p className="text-sm">Notification content...</p>
              <p className="text-xs">2 Jan, 2025</p>
            </Link>
          </li>
          <li role="none">
            <Link
            ...
            >
              <p className="text-sm">Notification content...</p>
              <p className="text-xs">3 Jan, 2025</p>
            </Link>
          </li>
        </ul>
      </div>
