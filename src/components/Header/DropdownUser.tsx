...
const DropdownUser = () => {
  ...
  useEffect(() => {
    const focusableItems = dropdown.current?.querySelectorAll(
      'a, button'
    );
    if (dropdownOpen) {
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 top-full mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default ${
